 ...
 * @package Xfers
 */
class XfersObject implements ArrayAccess, JsonSerializable
{
    /**
    ...
    /**
     * @return object The last response from the Xfers API
     */
     ...
     * @param ApiResponse
     *
     * @return void Set the last response from the Xfers API
     */
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_values) && array_key_exists($k, $this->_values)) {
            ...
            $message = "Xfers Notice: Undefined property of $class instance: $k. "
                . "HINT: The $k attribute was set in the past, however. "
                . "It was then wiped when refreshing the object "
                . "with the result returned by Xfers's API, "
            ...
            $class = get_class($this);
            error_log("Xfers Notice: Undefined property of $class instance: $k");
            return $nullval;
        }
    }
     ...
     * @param array $opts
     *
     * @return XfersObject The object constructed from the given values.
     */
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
                ...
                $this->_values[$k] = Util\Util::convertToXfersObject($v, $opts);
            }
    ...
    public function serializeParameters()
    {
        ...
        foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
            if (isset($this->$property)) {
                if ($this->$property instanceof XfersObject) {
    ...
    {
        if ($recursive) {
            return Util\Util::convertXfersObjectToArray($this->_values);
        } else {
            return $this->_values;
        }
    }
